export const translations = {
  he: {
    ...
    plansData: [
      {
        name: "סטארטר",
        price: "$499",
        desc: "הטוב ביותר לסטארטאפים בשלב מוקדם.",
        credits: "חד פעמי",
        features: [
          "גילוי ותכנון פרויקט",
          "עיצוב UI/UX",
      ...
      },
      {
        name: "סקייל",
        price: "$3,999",
        desc: "למותגים מוכנים לצמיחה מהירה.",
        credits: "מותאם אישית",
        features: [
          "הכל בצמיחה",
          "מנהל פרויקט ייעודי",
    ...
    faqDescription:
      "כל מה שצריך לדעת על עבודה עם הסוכנות שלנו. אם יש לך שאלות נוספות, אל תהסס ליצור קשר.",
    faqQuestions: [
      {
        question: "אילו שירותים הסוכנות שלכם מספקת?",
        answer:
          "אנחנו מציעים שירותים דיגיטליים מקצה לקצה כולל אסטרטגיית מותג, עיצוב UI/UX, פיתוח אתרים ואפליקציות ופתרונות שיווק מוכווני צמיחה.",
      },
      {
        question: "האם אתם עובדים עם סטארטאפים או רק חברות גדולות?",
        answer:
